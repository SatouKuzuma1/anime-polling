import { type Linkable } from "./common";
import { type AnimeBasic } from "./Anime";
import { type CharacterBasic } from "./Character";
import { type Image, type ImageSet } from "./Image";
import { type MangaBasic } from "./Manga";
...
/** @interface */
export type ClubBasic = Pick<
  Club,
  "id" | "name" | "logo" | "is_censored" | "join_policy" | "comment_policy"
> &
  Linkable;
